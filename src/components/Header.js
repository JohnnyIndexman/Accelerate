  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box alignSelf="flex-start" cursor="pointer" display={['block', 'block', 'none']}>
          <RiMenu2Line size="30px" onClick={handleClick} />
        </Box>
      </Box>

      {/* responsive menu */}
      <Box display={["flex", "flex", "none"]} alignItems="center" gap="50px" flexDirection='column'>
        <Box
          display="flex"
          alignItems="center"
          ...
          style={style}
        >
          <Text fontSize={["12.5px", "12.5px", "16px"]} fontWeight="500" mb="8px">
            <Link href="/">About us</Link>
          </Text>
          <Text fontSize={["12.5px", "12.5px", "16px"]} fontWeight="500" mb="8px">
            <Link href="/">Companies</Link>
